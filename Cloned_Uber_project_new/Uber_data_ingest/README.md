...
This folder defines all source code for the 'Uber_data_ingest' pipeline:
...
* Take a look at the sample under "sample_users_uber_data_ingest.py" to get familiar with the syntax.
